...
public class CourseAdapter extends ArrayAdapter<Course> {
    ...
    public CourseAdapter(Activity context, int resource, List<Course> list) {
        //Contect = activity hosting a ListView
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textViewTitle.setText(String.format("%s:%s",getContext().getString(R.string.code),course.getTitle()));
        textViewCredit.setText(String.format("%s:%s",getContext().getString(R.string.code),course.getCredit()));
        return rowView;
    }
}